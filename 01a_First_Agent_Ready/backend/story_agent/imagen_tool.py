...
class ImagenTool(BaseTool):
    ...
    async def run(self, ctx: ToolContext, **kwargs) -> str:
        ...
        try:
            ...
            style_prefix = (
                "Outdoor climbing illustration in a casual realistic style with natural earthy colors, clear mountain and rock features, "
                "friendly climbers in proper gear, simple yet accurate compositions, and consistent proportions."
            )
