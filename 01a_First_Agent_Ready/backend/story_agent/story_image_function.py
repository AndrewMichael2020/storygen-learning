...
class DirectImageFunction:
    ...
    def __init__(self, project_id: str = None):
        ...
        if project_id:
            ...
            raise ValueError("Project ID is required for DirectImageFunction")
    ...
    def _create_prompt_from_description(self, description: str, character_descriptions: Optional[Dict[str, str]] = None) -> str:
        ...
        locked_style = (
            """Outdoor climbing and alpine illustration with natural earthy colors, 
            realistic rock and mountain textures, simple clear compositions, 
            friendly casual climbers in safe realistic proportions, 
            appropriate for general audiences, consistent gear and environment details
            """
        )
